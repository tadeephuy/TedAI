"""
From https://github.com/lucidrains/Adan-pytorch with 
a slight modification at beta to
be compatible with OneCycleLR
"""
...
class Adan(Optimizer):
    def __init__(
        ...
        params,
        lr = 1e-3,
        betas = (0.02, 0.01), # beta1 and beta3
        beta2 = 0.08,
        eps = 1e-8,
        weight_decay = 0,
